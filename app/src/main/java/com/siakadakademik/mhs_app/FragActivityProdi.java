...
public class FragActivityProdi extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ListView list;
    ...
    private static final String TAG = FragActivityProdi.class.getSimpleName();

    private static String url_list = Server.URL + "prodi.php?offset=";
    ...
    public FragActivityProdi(){}
    View FragActivityProdiView;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        super.onCreate(savedInstanceState);
        FragActivityProdiView = inflater.inflate(R.layout.activity_mhs, container, false);

        getActivity().setTitle("Prodi");
        return FragActivityProdiView;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        id_fak = getActivity().getIntent().getStringExtra(TAG_ID_FAK);
        ...
        adapter = new ProdiAdaper(getActivity(), prodiList);
    ...
    private void callProdi(final String id_fak){
        swipe.setRefreshing(true);
                        ...
                        if (response.length() > 0) {
                            for (int i = 0; i < response.length(); i++) {
                                try {
                                    ...
                                    prodi.setId_fak(obj.getString(TAG_ID_FAK));
