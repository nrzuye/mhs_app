...
/**
 * Created by xyzz on 4/11/2018.
 */

public class Profil_Mhs extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void callDetailMhs(final String id_mhs) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url_detail, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(Profil_Mhs.this, "", Toast.LENGTH_SHORT).show();
                swipe.setRefreshing(false);
            }
        }) {
            @Override
    ...
    public void onBackPressed() {
        intent = new Intent(Profil_Mhs.this, DrawActivity.class);
        finish();
