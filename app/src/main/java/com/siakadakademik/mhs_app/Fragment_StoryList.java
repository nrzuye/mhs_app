...
import com.siakadakademik.mhs_app.adapter.Adapter_StoryList;
...
public class Fragment_StoryList extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (JsonUtils.isNetworkAvailable(Fragment_StoryList.this)) {
			...
			showToast("No Network Connection coy!!!");
