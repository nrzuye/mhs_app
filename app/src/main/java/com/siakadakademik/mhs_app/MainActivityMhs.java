...
public class MainActivityMhs extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ListView list;
    ...
    private static final String TAG = MainActivityMhs.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id_mhs) {
                Intent intent = new Intent(MainActivityMhs.this, DetailMhs.class);
        ...
        adapter = new MhsAdapter(MainActivityMhs.this, mhsList);
...
private void callMhs(int page){
    ...
    public void onBackPressed() {
        Intent intent = new Intent(MainActivityMhs.this, MainActivity.class);
        finish();
        startActivity(intent);
    }
