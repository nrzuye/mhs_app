...
public class MhsCuti extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ListView list;
    ...
    private static final String TAG = MhsCuti.class.getSimpleName();

    private static String url_list = Server.URL + "mhs_cuti.php?offset=";
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id_mhs) {
                Intent intent = new Intent(MhsCuti.this, DetailMhs.class);
        ...
        adapter = new MhsAdapter(MhsCuti.this, mhsList);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(MhsCuti.this, MainActivity.class);
        finish();
        startActivity(intent);
    }
