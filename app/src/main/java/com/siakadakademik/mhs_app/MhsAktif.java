...
public class MhsAktif extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ListView list;
    ...
    private static final String TAG = MhsAktif.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id_mhs) {
                Intent intent = new Intent(MhsAktif.this, DetailMhs.class);
        ...
        adapter = new MhsAdapter(MhsAktif.this, mhsList);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(MhsAktif.this, MainActivity.class);
        finish();
        startActivity(intent);
    }
